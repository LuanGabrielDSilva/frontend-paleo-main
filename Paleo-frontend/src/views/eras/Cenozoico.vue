...
const CENOZOICO_ID = "b2477f76-b1bc-4da4-99e5-7885fb87829c";

const carouselImages = ref([
  {
    url: "https://portal.unicap.br/documents/475537/1511074/veja-megafauna-xenorinoterio-gliptodonte-mastodonte.jpeg/be9c27bf-2b13-7688-82d2-2dae0d312d1b?t=1687976185704",
    caption: "Megafauna do Pleistoceno",
    tag: "Quaternário",
  },
  {
    url: "https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=1200&q=80",
    caption: "Savanas — berço dos hominídeos",
    tag: "Neógeno",
  },
  {
    url: "https://aventurasnahistoria.com.br/wp-content/uploads/2025/01/relevo-era-glacial-capa.jpg",
    caption: "Grandes geleiras cobrem continentes",
    tag: "Pleistoceno",
  },
  {
    url: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh_IVq3S8jxBRhmZtdXrq0YD4nP3eXIo6mgoKHcbUz9CGbEcMevGcU6b_UXyh4nkG1uf5-3qZKC1pM9y_SIitA58_JHuWKRwznoD_C54QxE_mL7uMwRiPSM_hPSMnr91OiUoCOmniZZsWAzwyatBr_JW6r4C1o6pskRZhCISIuB86FnWE5AJ1oIAxpZgA/w1200-h630-p-k-no-nu/Cenozoic%20Era%20Animals%20-%20Christian%20J%C3%A9gou.jpg",
    caption: "Mamíferos dominam o planeta",
    tag: "Paleógeno",
  },
  {
  ...
  <div class="page">
    ...
    <div class="hero">
      ...
      <div class="overlay">
        ...
        <h1>Cenozoico</h1>
        <p class="lead">
          A era dos mamíferos gigantes e o surgimento da humanidade.
        </p>
    ...
    <section class="content">
      ...
      <div class="prose-with-carousel">
        <div class="prose">
          <p class="drop-cap">
            O Cenozoico começou após a grande extinção que eliminou os
            dinossauros não-aviários. É a era em que os mamíferos se tornaram
            dominantes e, mais recentemente, o ser humano surgiu.
          </p>
          <p>
            Durante esse período surgiram grandes mamíferos como mamutes,
            tigres-dentes-de-sabre, megaterios e os primeiros hominídeos que
            evoluiriam até o Homo sapiens.
          </p>
          <p>
        ...
        <!-- 🎞️ Carrossel decorativo (altura = altura do texto) -->
        <aside
          class="carousel"
          @mouseenter="carouselPaused = true"
          @mouseleave="carouselPaused = false"
          aria-label="Galeria do Cenozoico"
        >
            ...
            <div class="era-gallery">
              <div class="era-img-main">
                ...
                <span class="era-index">
                  ...
                  {{ String(periodos.length).padStart(2, "0") }}
                </span>
              </div>
            </div>
...
.prose-with-carousel {
  ...
  align-items: stretch;   /* ⬅️ faz o carrossel esticar até a altura do texto */
  margin-bottom: 120px;
}
.prose {
  max-width: 640px;
...
.carousel {
  ...
  flex-direction: column;
  gap: 14px;
  height: 100%;          /* ⬅️ ocupa exatamente a altura do texto ao lado */
  min-height: 0;
  animation: rise 1.2s cubic-bezier(0.2, 0.8, 0.2, 1) both;
}
.carousel-frame {
  position: relative;
  flex: 1;               /* ⬅️ a moldura cresce para preencher a coluna */
  min-height: 0;
  display: flex;
...
.carousel-stage {
  position: relative;
  flex: 1;               /* ⬅️ palco preenche a moldura toda */
  min-height: 0;
  width: 100%;
  overflow: hidden;
  border-radius: 2px;
...
.slide img {
  width: 100%; height: 100%;
  object-fit: cover;
  filter: brightness(0.72) contrast(1.1) saturate(0.88) sepia(0.22);
  transform: scale(1.05);
